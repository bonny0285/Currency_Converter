...
class InfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        MyAnalytics.myAnalytics(forEvent: "ViewDidLoad InfoViewController", forViewController: self, forText: "Customer check my info")
...
extension InfoViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        MyAnalytics.myAnalytics(forEvent: "DidSelectRowAt InfoViewController", forViewController: self, forText: "Customer has checked \(nomeAppArray[indexPath.row])")
